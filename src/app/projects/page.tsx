...
const projetos = [
  ...
  },
  {
    ...
    descricao:
      'Espaço de formação e articulação comunitária com foco em meio ambiente, autocuidado e economia criativa.',
    imagem: '/images/casa-da-natureza.jpg',
  },
  {
    titulo: 'Ela Fav Mob',
    descricao:
      'Ações de fortalecimento comunitário e cultural em favelas, com oficinas e rodas de conversa.',
    imagem: '/images/ela-fav-mob.jpg',
  },
  {
    titulo: 'Jovem de Expressão',
    descricao:
      'Projeto voltado à juventude, com ações culturais e socioambientais nas periferias do DF.',
